                ...
                return (
                  <Card key={nest.name} variant="inner">
                    ...
                    <ProgressBar
                      ...
                      height={5}
                    />
                    <div className="flex items-center justify-between mt-1.5 text-[11px] text-[var(--t2)]">
                      <span>
          ...
          <Card variant="accent">
            ...
            <div className="grid grid-cols-2 gap-3 text-center">
              <div>
                ...
                <p className="text-[10px] text-[var(--t2)]">Saved</p>
              </div>
              <div>
                <p className="text-lg font-black text-[var(--t1)]">
                  {formatCurrency(emergency.goal)}
                </p>
                <p className="text-[10px] text-[var(--t2)]">Target</p>
              </div>
            </div>
          ...
          <Card>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[13px] font-bold text-[var(--neg)]">
                  -$1,200
                </span>
              </div>
              <ProgressBar percent={65} color="var(--warn)" height={5} />
